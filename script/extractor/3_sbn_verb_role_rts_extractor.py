      ...
      if not sbn_parsing_in_order:
        ...
        for verb_role_data in sbn_verb_role_data:
          ...
          for subj_nr, (rt, sent_pos) in spr_rt_all_subj.items():
            ...
            spr_copy_role_data['sent_pos'] = sent_pos
            spr_spill = -999
          ...
          for subj_nr, (subj_rt_ff, subj_rt_fp, subj_rt_rb, subj_rt_gp, sent_pos) in et_data_with_subj[sent_nr][word_pos].items():
            ...
            et_copy_role_data['sent_pos'] = sent_pos
            et_spill_ff = -999
            et_spill_fp = -999
            et_spill_rb = -999
            et_spill_gp = -999
            ...
            et_copy_role_data['rt_ff'] = subj_rt_ff
            et_copy_role_data['rt_fp'] = subj_rt_fp
            et_copy_role_data['rt_rb'] = subj_rt_rb
            et_copy_role_data['rt_gp'] = subj_rt_gp
