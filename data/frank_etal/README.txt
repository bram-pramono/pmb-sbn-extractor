...
REFERENCES
[1] Frank, S.L., Fernandez Monsalve, I., Thompson, R.L, & Vigliocco, G. (in press). Reading-time data for evaluating
    broad-coverage models of English sentence processing. Behavior Research Methods.
...
NOTE -- Subject #20 scored only 14.5% correct. Most likely, she was misinformed
        (or confused) about the response buttons, so her "correct" responses were
        counted as incorrect and vice versa.
